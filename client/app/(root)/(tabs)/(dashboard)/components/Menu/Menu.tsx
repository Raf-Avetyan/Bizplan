...
function getWorkspaceItems(t: ReturnType<typeof getMenuCopy>): MenuItem[] {
  return [
    ...
    { label: t.settings, description: t.settingsDescription, route: "/settings", icon: Settings },
  ];
}
...
function getMenuCopy(language: "en" | "ru" | "hy") {
  if (language === "ru") {
    return {
      ...
      settings: "Настройки",
      settingsDescription: "Управлять поведением приложения",
  ...
  if (language === "hy") {
    return {
      ...
      settingsDescription: "Կառավարել հավելվածի վարքագիծը",
  ...
  return {
    ...
    settings: "Settings",
    settingsDescription: "Control the app behavior",
